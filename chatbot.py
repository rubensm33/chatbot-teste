...
async def lastname(update: Update, _: ContextTypes.DEFAULT_TYPE) -> AGE:
    ...
    await update.message.reply_text("In order for us to proceed with your service, please enter your age.",)
    return AGE
...
def main() -> None:
    ...
    app = (
        ApplicationBuilder()
        .token("5890227974:AAFI_vdRD7GXSE3Iy4aiE6GF6vFAhMt_J3w").build()
    )
